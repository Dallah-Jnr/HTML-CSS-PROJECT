...
This project is a demonstration of a simple website built using only HTML and CSS. It showcases the use of these core web technologies to create a responsive and visually appealing web page with different types of animations.
...
![Project Demo](https://drive.google.com/drive/folders/1ZYLL1OLW2-2GVMGSST_uiBEQBPLk7wip?usp=drive_link)
